...
public class PanjabAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panjab_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(PanjabAttraction.this);




        firebaseFirestore.collection("Panjab").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(PanjabAttraction.this,Information.class);
