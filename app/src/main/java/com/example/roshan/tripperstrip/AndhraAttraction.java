...
import java.util.List;
 ...
 public class AndhraAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_andhra_attraction);
         ...
         cityRecyclerAdapter.setOnItemClicklistener(AndhraAttraction.this);



         firebaseFirestore.collection("Andhra").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
             @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(AndhraAttraction.this,Information.class);
