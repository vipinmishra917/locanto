...
public class MizoramAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mizoram_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(MizoramAttraction.this);


        firebaseFirestore.collection("Mizoram").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(MizoramAttraction.this,Information.class);
