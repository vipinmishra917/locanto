...
public class MadhyaPardeshAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_madhya_pardesh_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(MadhyaPardeshAttraction.this);


        firebaseFirestore.collection("MadhyaPardeshAttraction").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(MadhyaPardeshAttraction.this,Information.class);
