...
public class TamilNaduAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_nadu_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(TamilNaduAttraction.this);

        firebaseFirestore.collection("TamilNadu").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(TamilNaduAttraction.this,Information.class);
