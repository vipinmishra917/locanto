...
public class DelhiAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delhi_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(DelhiAttraction.this);
        firebaseFirestore.collection("Delhi").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(DelhiAttraction.this,Information.class);
