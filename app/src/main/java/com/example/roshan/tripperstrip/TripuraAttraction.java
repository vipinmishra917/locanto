...
public class TripuraAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tripura_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(TripuraAttraction.this);


        firebaseFirestore.collection("Tripura").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(TripuraAttraction.this,Information.class);
