...
public class JammuKashmir extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityRecyclerAdapter.setOnItemClicklistener(JammuKashmir.this);


        firebaseFirestore.collection("JammuKashmir").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(JammuKashmir.this,Information.class);
