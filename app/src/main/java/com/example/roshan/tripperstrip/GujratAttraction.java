...
public class GujratAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gujrat_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(GujratAttraction.this);


        firebaseFirestore.collection("Gujrat").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(GujratAttraction.this,Information.class);
