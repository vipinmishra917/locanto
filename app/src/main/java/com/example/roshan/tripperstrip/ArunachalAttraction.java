...
public class ArunachalAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arunachal_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(ArunachalAttraction.this);


        firebaseFirestore.collection("Arunachal Pradesh").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(ArunachalAttraction.this,Information.class);
