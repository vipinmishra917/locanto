...
public class ChhattisgarhAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chhattisgarh_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(ChhattisgarhAttraction.this);

        firebaseFirestore.collection("Chhattisgarh").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(ChhattisgarhAttraction.this,Information.class);
