...
public class BiharAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bihar_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(BiharAttraction.this);

        firebaseFirestore.collection("Bihar").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(BiharAttraction.this,Information.class);
