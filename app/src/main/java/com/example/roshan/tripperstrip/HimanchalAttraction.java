...
public class HimanchalAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himanchal_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(HimanchalAttraction.this);




        firebaseFirestore.collection("Himanchal").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(HimanchalAttraction.this,Information.class);
