...
public class OdishaAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_odisha_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(OdishaAttraction.this);


        firebaseFirestore.collection("Odisha").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(OdishaAttraction.this,Information.class);
