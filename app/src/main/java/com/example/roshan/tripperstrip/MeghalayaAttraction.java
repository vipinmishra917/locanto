...
public class MeghalayaAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meghalaya_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(MeghalayaAttraction.this);


        firebaseFirestore.collection("Megahalaya").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(MeghalayaAttraction.this,Information.class);
