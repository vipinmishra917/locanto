...
public class UttarPradeshAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityRecyclerAdapter.setOnItemClicklistener(UttarPradeshAttraction.this);

        firebaseFirestore.collection("UttarPradesh").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(UttarPradeshAttraction.this,Information.class);
