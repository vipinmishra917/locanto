...
public class KarnatakaAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karnataka_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(KarnatakaAttraction.this);


        firebaseFirestore.collection("Karnataka").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(KarnatakaAttraction.this,Information.class);
