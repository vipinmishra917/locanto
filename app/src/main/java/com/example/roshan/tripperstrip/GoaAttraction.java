...
public class GoaAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goa_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(GoaAttraction.this);


        firebaseFirestore.collection("Goa").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(GoaAttraction.this,Information.class);
