...
public class SkimmAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skimm_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(SkimmAttraction.this);

        firebaseFirestore.collection("Skkim").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(SkimmAttraction.this,Information.class);
