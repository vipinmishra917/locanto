...
public class JharkhandAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jharkhand_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(JharkhandAttraction.this);


        firebaseFirestore.collection("jharkhand").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(JharkhandAttraction.this,Information.class);
