...
public class UttrakhandAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttrakhand_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(UttrakhandAttraction.this);

        firebaseFirestore.collection("Uttrakhand").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(UttrakhandAttraction.this,Information.class);
