...
public class NagalandAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagaland_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(NagalandAttraction.this);




        firebaseFirestore.collection("Nagaland").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(NagalandAttraction.this,Information.class);
