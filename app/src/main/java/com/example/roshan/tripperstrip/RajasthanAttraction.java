...
public class RajasthanAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajasthan_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(RajasthanAttraction.this);



        firebaseFirestore.collection("Rajasthan").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent information = new Intent(RajasthanAttraction.this,Information.class);
