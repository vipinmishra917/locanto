...
public class WestBengalAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_west_bengal_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(WestBengalAttraction.this);


        firebaseFirestore.collection("WestBengal").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(WestBengalAttraction.this,Information.class);
