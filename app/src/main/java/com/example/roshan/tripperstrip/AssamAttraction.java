...
public class AssamAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assam_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(AssamAttraction.this);
        firebaseFirestore.collection("Assam").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(AssamAttraction.this,Information.class);
