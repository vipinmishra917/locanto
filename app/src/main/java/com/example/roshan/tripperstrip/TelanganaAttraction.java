...
public class TelanganaAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telangana_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(TelanganaAttraction.this);



        firebaseFirestore.collection("Telangana").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        Intent information = new Intent(TelanganaAttraction.this,Information.class);
