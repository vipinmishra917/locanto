...
public class HaryanaAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haryana_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(HaryanaAttraction.this);


        firebaseFirestore.collection("Haryana").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(HaryanaAttraction.this,Information.class);
