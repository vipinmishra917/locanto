...
public class MaharastraAttraction extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maharastra_attraction);
        ...
        cityRecyclerAdapter.setOnItemClicklistener(MaharastraAttraction.this);


        firebaseFirestore.collection("Maharastra").addSnapshotListener(this,new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onItemClick(int position) {
        ...
        Intent information = new Intent(MaharastraAttraction.this,Information.class);
